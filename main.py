...
async def upload(bot: Client, m: Message):
    ...
    try:
        for i in range(count - 1, len(links)):
            ...
            elif "static" in url or "transcoded-videos" in url:
                cmd = f'yt-dlp --add-header "Referer: https://appx-play.akamai.net.in/" --add-header "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64)" "{url}"'
